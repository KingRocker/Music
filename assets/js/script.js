...
function deletePlaylist(playlistId) {
    var promp = confirm("Are you sure you want to delete this Playlist?");
...
function showOptionsMenu(button){
    ...
    menu.find(".songId").val(songId); //finds song id

    var scrollTop = $(window).scrollTop(); // distance from top of window to top of document
    var elementOffset = $(button).offset().top; // gets position of button from the top of document
